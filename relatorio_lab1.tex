...
Foram percorridas três páginas, com 15 anúncios em cada uma. Dos 45 anúncios, um link repetido foi removido, restando 44 URLs distintas. Duas páginas individuais não carregaram o conteúdo esperado; 42 vagas foram incluídas no CSV, sem URLs duplicadas. Em 29 registros, o salário consta como \texttt{Não especificado}. O portal marcou 36 das 42 vagas como \texttt{Vencida}; seis não exibiam esse selo. A ausência do selo não comprova que o anúncio ainda esteja aberto. A presença de vagas vencidas e a indisponibilidade de duas páginas limitam o uso do arquivo como lista de oportunidades atuais.
